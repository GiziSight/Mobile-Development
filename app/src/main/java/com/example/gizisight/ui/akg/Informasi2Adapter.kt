...
class Informasi2Adapter(private val listBagian: List<Bagian2Item>) : RecyclerView.Adapter<Informasi2Adapter.ListViewHolder>() {
    class ListViewHolder(private val binding: ItemInformasiGiziBinding) : RecyclerView.ViewHolder(binding.root) {

        fun bind(data: Bagian2Item, position: Int) {
            binding.apply {
